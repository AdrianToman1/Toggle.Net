...
namespace Toggle.Net.Providers.TextFile
{
    ...
    public class FileParser : IFeatureProviderFactory
    {
        ...
        public const string MustOnlyBeDeclaredOnce =
            "Feature '{0}' is declared twice at line {1}. This is not allowed when you've set ThrowIfFeatureIsDeclaredTwice to true.";
            ...
            for (var index = 0; index < content.Length; index++)
            {
                ...
                switch (splitByEqualSign.Length)
                {
                    ...
                    case 2:
                        ...
                        parseRow(readFeatures, specificationMappings, leftOfEqualSign, rightOfEqualSign, rowNumber,
                            exOutput);
                        break;
                    default:
            ...
            StringBuilder exOutput)
        {
            ...
            switch (splitLeftByDots.Length)
            {
                case 1:
                    ...
                    addSpecificationToFeature(readFeatures, specificationMappings, rowNumber, exOutput,
                        specificationName, toggleName);
                    break;
                case 3:
                    ...
                    try
                    {
                        ...
                        {
                            feature = addSpecificationToFeature(readFeatures, specificationMappings, rowNumber,
                                exOutput, specificationName, toggleName);
                        }
        ...
        private Feature addSpecificationToFeature(IDictionary<string, Feature> readFeatures,
            IDictionary<string, IToggleSpecification> specificationMappings, int rowNumber,
        ...
        {
            if (AllowedFeatures != null && !AllowedFeatures.Any(x =>
                    string.Equals(x.Trim(), toggleName, StringComparison.CurrentCultureIgnoreCase)))
            {
