...
namespace Toggle.Net.Specifications
{
    public class RandomSpecification : IToggleSpecification
    {
        ...
        public const string MustHaveDeclaredPercent =
            "Missing RandomSpecification parameter '" + percentParameter + "' for feature '{0}'.";

        public const string MustDeclaredPercentAsInt = "RandomSpecification parameter '" + percentParameter +
                                                       "' for feature '{0}' must be declared as an int.";
